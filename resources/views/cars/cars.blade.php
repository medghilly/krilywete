...
<div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg mb-10">
        <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Trouvez la voiture parfaite</h2>
        <form action="{{route('carSearch')}}" method="GET">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                ...
                <button type="submit" 
                    class="h-10 bg-pr-500 hover:bg-pr-600 text-white font-medium rounded-lg transition duration-200 flex items-center justify-center">
