        ...
        <div class="w-full lg:w-4/5 space-y-8 text-gray-700 leading-relaxed">
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <p class="pl-8">Les présentes Conditions Générales sont régies par et interprétées conformément au droit marocain. Tout litige relatif à leur exécution ou interprétation sera de la compétence exclusive des tribunaux marocains.</p>
                </div>
            </div>
            ...
            <div class="mt-12 p-6 bg-gray-50 rounded-lg">
                ...
                <ul class="mt-2 space-y-1">
                    <li class="flex items-start">
                        ...
                        <span>contact@realrentcar.ma</span>
                    </li>
                    <li class="flex items-start">
                        <svg class="h-5 w-5 text-gray-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
