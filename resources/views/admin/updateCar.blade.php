    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-pr-500 to-pr-600 p-6">
                <h2 class="text-2xl font-bold text-white text-center">Modification de la voiture</h2>
                <p class="mt-1 text-center text-pr-100">{{ $car->brand }} {{ $car->model }} {{ $car->engine }}</p>
            </div>

            <form action="{{ route('cars.update', ['car' => $car->id]) }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="model" id="model" required value="{{ $car->model }}"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-pr-500 focus:ring focus:ring-pr-200 focus:ring-opacity-50 py-2 px-4 border"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="engine" id="engine" required value="{{ $car->engine }}"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-pr-500 focus:ring focus:ring-pr-200 focus:ring-opacity-50 py-2 px-4 border"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="quantity" id="quantity" required min="1" value="{{ $car->quantity }}"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-pr-500 focus:ring focus:ring-pr-200 focus:ring-opacity-50 py-2 px-4 border"
                                    placeholder="Ex: 5">
                                @error('quantity')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="price_per_day" id="price_per_day" required min="1" value="{{ $car->price_per_day }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="reduce" id="reduce" min="0" max="100" value="{{ $car->reduce }}"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-pr-500 focus:ring focus:ring-pr-200 focus:ring-opacity-50 py-2 px-4 border"
                                    placeholder="Ex: 15">
                                @error('reduce')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div class="w-full md:w-1/3">
                            ...
                            <div class="border rounded-lg overflow-hidden">
                                <img src="{{ $car->image }}" alt="Image actuelle de la voiture" class="w-full h-auto object-cover">
                            </div>
                        </div>
                        
                        <!-- Upload de nouvelle image -->
                        <div class="w-full md:w-2/3">
                            <h4 class="text-sm font-medium text-gray-700 mb-2">Changer l'image</h4>
                    ...
                    <div class="mt-4">
                        <div class="flex items-center space-x-6">
                            <div class="flex items-center">
                                <input id="available" name="status" type="radio" value="available" {{ $car->insurance_status == 'available' ? 'checked' : '' }}
                            ...
                            <div class="flex items-center">
                                <input id="unavailable" name="status" type="radio" value="unavailable" {{ $car->insurance_status == 'unavailable' ? 'checked' : '' }}
                                    class="h-4 w-4 text-pr-600 focus:ring-pr-500 border-gray-300">
