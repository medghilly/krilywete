                                ...
                                <div class="space-y-1">
                                    <label class="block text-sm font-medium text-gray-700">
                                        ...
                                        @if(env('DEMO_MODE', false))
                                            <span class="text-xs text-blue-600 font-normal">(optionnel en mode démo)</span>
                                        @endif
                                    </label>
                                    <input type="file" name="payment_screenshot" accept="image/*" {{ env('DEMO_MODE', false) ? '' : 'required' }}
